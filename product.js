...
const products = [
  ...
  // qolgan productlarni ham script.js dagidek shu yerga qo'yasan
];
  ...
  detail.innerHTML = `
    <div class="product-detail-grid">
      <div class="product-detail-left">
        <img src="${product.image}" alt="${product.name}" class="product-detail-main-image" />
      </div>
      ...
      <div class="product-detail-right">
        ...
        <p class="product-detail-meta"><strong>Razmerlar:</strong> ${product.sizes.join(", ")}</p>
        <p class="product-detail-meta"><strong>Yetkazib berish:</strong> 1-2 kun ichida</p>

        <button class="order-btn ${!isAvailable ? "disabled" : ""}" ${!isAvailable ? "disabled" : ""}>
...
async function initProductPage() {
  ...
  if (!product) {
    detail.innerHTML = "<p>Mahsulot topilmadi.</p>";
    return;
  }
